/*
60256309 稲葉 真幸
超点数が4以外の図形を追加すると、プログラムの大幅な変更が必要になってしまうので、L字型の面の部分は2つの三角形を用いて描画しました。
...
void display(void)
{
    ...
    for (int i = 0; i < 10; i++) { //1面ずつ
        ...
        eyeVector[1] = 0.0 - vertices[model_f[i][0]][1];
        eyeVector[2] = 1.9 - vertices[model_f[i][0]][2];
